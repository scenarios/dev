...
ann_file_val = '/mnt/wfs/mmcommwfssz/project_mm-base-vision/harryizzhou/projects/video_understanding/data/kinetics700_list/val_reorged.csv'
ann_file_test = '/mnt/wfs/mmcommwfssz/project_mm-base-vision/harryizzhou/projects/video_understanding/data/kinetics700_list/val_reorged.csv'
img_norm_cfg = dict(
